...
FireballActor::FireballActor(int x, int y, int deltaX, int deltaY)
	: PlacableActor(x, y)
...
void FireballActor::Draw()
{
	std::cout << (char)155;
}

void FireballActor::Update()
{
	if (m_movementInX != 0)
	{
...
void FireballActor::UpdateDirection(int& current, int& direction, int& movement)
{
	current += direction;
